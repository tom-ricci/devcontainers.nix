        ...
        in
        {
          ...
          layers =
            let
              ...
              defaultFonts = {
                serif = [ "NotoSerif Nerd Font" ] ++ emoji ++ [ "Noto Sans CJK SC" ];
                sansSerif = [ "NotoSans Nerd Font" ] ++ emoji ++ [ "Noto Sans CJK SC" ];
                monospace = [ "NotoMono Nerd Font" ] ++ emoji ++ [ "Noto Sans CJK SC" ];
                emoji = emoji;
              };
